...
export function NotificationsDropdown() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-80 overflow-hidden rounded-2xl border border-border-soft bg-bg-surface shadow-[0_8px_24px_-8px_rgba(28,26,23,0.12)] z-50">
